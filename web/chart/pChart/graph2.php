...
function genereerGrafiek($resultaten = 0, $naamOrg = "PACKED"){
...
$MyData->addPoints(array("Mandaat en beleid","Toegankelijkheid","Preservation Watch","Digital preservation metadata","Inname (ingest) digitale objecten","Overzicht en inschatting van de te archiveren digitale objecten", "Verantwoord opslagbeheer", "Taken en verantwoordelijkheden", "Bewaarstrategie"),"Families");
...
$myPicture->drawText(10,13,"Resultaten - $naamOrg (". date('d-m-Y') .")",array("R"=>255,"G"=>255,"B"=>255));
...
/* Draw a radar chart */ 
$myPicture->setGraphArea(250,25,500,500);
$Options = array("DrawPoly"=>TRUE,"WriteValues"=>TRUE,"ValueFontSize"=>8,"Layout"=>RADAR_LAYOUT_STAR, "LabelPos"=>RADAR_LABELS_HORIZONTAL, "BackgroundGradient"=>array("StartR"=>255,"StartG"=>0,"StartB"=>0,"StartAlpha"=>100,"EndR"=>0,"EndG"=>139,"EndB"=>69,"EndAlpha"=>50));
